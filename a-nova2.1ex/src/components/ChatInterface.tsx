...
const ChatInterface = React.memo(function ChatInterface({
  ...
  return (
    ...
    >
      ...
      <header className={`h-10 sm:h-12 md:h-15 w-full max-w-full flex items-center justify-between px-2 sm:px-3 md:px-4 border-b shrink-0 ${
      ...
      >
        {!session || !session.messages || session.messages.length === 0 ? (
          ...
          <div className="w-[90%] sm:w-full max-w-2xl mx-auto px-2.5 sm:px-3 md:px-4 py-3 sm:py-6 md:py-20 flex flex-col items-center justify-center text-center space-y-3 sm:space-y-4 md:space-y-8 select-none my-auto">
            <motion.div
            ...
            >
              <AnovaLogo size="xl" showText={true} subtitle={activePreset.title.toUpperCase()} animated={true} />
            </motion.div>
      ...
      {/* Unified Input area */}
      <footer className={`p-1 sm:p-2 md:p-4 border-t shrink-0 pb-safe w-full max-w-full min-w-0 ${
        isDark ? "bg-zinc-950/40 border-zinc-900" : "bg-zinc-50/30 border-zinc-150"
      }`}>
        <div className="w-full max-w-2xl px-2 sm:px-3 mx-auto space-y-1 md:space-y-3">
          ...
          >
            ...
            {webSearchActive && (
              <div className="flex items-center gap-1.5 px-3 sm:px-4 pt-2.5 select-none text-emerald-500 text-[10px] font-bold font-mono">
            ...
            <div className="flex items-center gap-1 sm:gap-1.5 md:gap-2 px-1.5 py-1 sm:px-2 sm:py-1.5 md:px-3 md:py-2">
              ...
              <div className="flex items-center justify-center shrink-0">
                <button
                  ...
                  className={`flex h-7.5 w-7.5 sm:h-8 sm:w-8 md:h-9 md:w-9 items-center justify-center rounded-full transition-all cursor-pointer ${
                    isPlusMenuOpen 
                  ...
                  title="Attach & Tools"
                >
                  <Plus className={`w-3.5 h-3.5 sm:w-4 sm:h-4 md:w-5 md:h-5 transition-transform duration-200 ${isPlusMenuOpen ? "rotate-45" : ""}`} />
                </button>
              </div>
              ...
              <textarea
                ...
                className="w-full bg-transparent px-1 py-0.5 md:py-1 text-xs sm:text-sm focus:outline-none placeholder-zinc-400 dark:placeholder-zinc-500 font-sans resize-none block flex-1 max-h-36 min-h-[1.75rem] sm:min-h-[2rem] md:min-h-[2.25rem] overflow-y-auto"
              />
              ...
              <div className="flex items-center gap-1 sm:gap-1.5 shrink-0">
                ...
                {(!inputText.trim() && attachedFiles.length === 0) ? (
                  ...
                  >
                    {isListening ? <MicOff className="w-3.5 h-3.5 sm:w-4 sm:h-4 md:w-4.5 md:h-4.5" /> : <Mic className="w-3.5 h-3.5 sm:w-4 sm:h-4 md:w-4.5 md:h-4.5" />}
                  </button>
                ) : (
                  <button
                    type="submit"
                    disabled={loading || (!inputText.trim() && attachedFiles.length === 0)}
                    className="flex h-7.5 w-7.5 sm:h-8 sm:w-8 md:h-9 md:w-9 items-center justify-center rounded-full bg-purple-600 hover:bg-purple-550 text-white shadow-md transition-all cursor-pointer disabled:opacity-50"
                    title="Send message"
                  >
                    {loading ? <Loader2 className="w-3.5 h-3.5 sm:w-4 sm:h-4 md:w-4.5 md:h-4.5 animate-spin" /> : <ArrowUp className="w-3.5 h-3.5 sm:w-4 sm:h-4 md:w-4.5 md:h-4.5 stroke-[2.5]" />}
                  </button>
                )}
                ...
                <>
                  ...
                  <motion.div
                    ...
                    className={`z-50 select-none ${
                      ...
                      "sm:absolute sm:left-2 sm:bottom-14 sm:w-48 sm:rounded-2xl sm:p-1.5 sm:shadow-xl " +
                      (isDark 
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-0.5">
                      ...
                      <button
                        ...
                        className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-xs font-medium transition-all cursor-pointer text-left ${
                          isDark 
