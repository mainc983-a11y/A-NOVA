  ...
  return (
    <>
      ...
      <aside
        ...
        } ${isCollapsed ? "lg:w-16 w-72 max-w-[85vw]" : "lg:w-68 w-72 sm:w-80 max-w-[85vw]"} ${
          isDark 
        ...
        <div className="flex-1 overflow-y-auto p-2 sm:p-2.5 md:p-3 space-y-2 sm:space-y-3 md:space-y-4">
          ...
          <div>
            <button
              ...
              className={`w-full group relative flex items-center gap-2 px-2.5 py-1.5 sm:px-3 sm:py-2 text-xs font-semibold rounded-xl border transition-all cursor-pointer ${
            ...
            {CORES.map((core) => {
              ...
              return (
                <button
                  ...
                  className={`w-full group relative flex items-center gap-2.5 p-1.5 sm:p-2 rounded-xl cursor-pointer text-xs transition-all ${
                    isActive
    ...
    return (
      ...
      >
        <button
          ...
          className={`w-full relative flex items-center gap-2 px-2 py-1 sm:px-2.5 sm:py-1.5 rounded-xl text-left cursor-pointer text-[12px] md:text-[12.5px] transition-all group-hover:pr-18 ${
            isActive
              ? isDark 
