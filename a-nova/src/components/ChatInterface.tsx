  ...
  return (
    <div className="flex items-center justify-center gap-1 sm:gap-1.5 h-7 px-3 select-none">
      {barValues.map((val, idx) => {
        ...
        const barHeight = Math.max(4, Math.min(26, Math.round(factor * 24 + volFactor * 12)));
...
const ChatInterface = React.memo(function ChatInterface({
  ...
  }, [stopSpeakingAction, settings?.voiceName, settings?.voiceLanguage, settings?.speechSpeed]);
      ...
      {onToggleSidebar && (
        <div className="fixed top-3 left-3 sm:top-4 sm:left-4 z-30 pointer-events-auto">
          <button
            ...
            className={`w-9 h-9 sm:w-10 sm:h-10 flex items-center justify-center rounded-full transition-all duration-200 cursor-pointer shadow-sm md:shadow-md backdrop-blur-md border ${
              isDark
          ...
          >
            ...
            <div className="flex items-center gap-1.5 sm:gap-2 px-3.5 py-1 sm:px-4 sm:py-2">
              ...
              <div className="relative flex-1 flex items-center justify-center my-auto min-h-[24px] sm:min-h-[28px] overflow-hidden">
                {isListening && activeMode === "general" ? (
              ...
              <div className="flex items-center gap-1.5 sm:gap-2 shrink-0 my-auto">
                ...
                {isListening ? (
                  ...
                  <div className="flex items-center gap-1.5 shrink-0">
                    {/* Text-to-Speech Waveform button (Only shown in General Chat) */}
                    {activeMode === "general" && (
                      <button
                        type="button"
                        onClick={() => {
