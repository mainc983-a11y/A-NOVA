    ...
    <div className="py-2 px-4 transition-colors w-full flex justify-center">
      <div className={`w-full flex gap-3 ${
        ...
        <div className={`flex flex-col max-w-[85%] md:max-w-[75%] space-y-1 ${
          ...
          <div className={`px-4 py-2.5 mt-0.5 rounded-2xl border text-left shadow-none ${
            isAssistant
              ? isDark 
    ...
    >
      ...
      >
        {!session || !session.messages || session.messages.length === 0 ? (
          ...
          <div className="max-w-2xl mx-auto px-4 py-12 md:py-20 flex flex-col items-center justify-center text-center space-y-8 select-none my-auto">
            <motion.div
            ...
            {!session && (
              <div className="pt-2">
                <span className="px-4 py-1.5 rounded-full bg-cyan-500/10 border border-cyan-500/20 text-cyan-400 text-[10px] font-mono">
          ...
          <div className="w-full py-2">
            ...
            {loading && (
              <div className="py-2.5 px-4 w-full flex justify-center">
                <div className={`w-full flex gap-3 ${
                  settings?.chatWidth === "full" ? "max-w-5xl" : "max-w-3xl"
                } justify-start`}>
                  <div className="w-[26px] h-[26px] rounded-full bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 flex items-center justify-center shrink-0 mt-0.5 shadow-sm">
                  ...
                  <div className="flex flex-col space-y-1 items-start max-w-[85%]">
                    ...
                    <div className={`px-4 py-2 mt-0.5 rounded-2xl border text-left text-xs bg-zinc-50 dark:bg-zinc-900/40 border-zinc-200 dark:border-zinc-800 text-zinc-500 dark:text-zinc-450 shadow-none`}>
            ...
            <div className="flex items-center justify-between px-3 pb-2 pt-1 border-t border-transparent dark:border-transparent select-none">
              ...
              <div className="flex items-center gap-1">
                <button
                  ...
                  disabled={loading}
                  onClick={() => {
                    setExpandInputActive(!expandInputActive);
                  }}
              ...
              {isPlusMenuOpen && (
                <>
                  ...
                  <motion.div
                    ...
                    className={`absolute left-2 bottom-14 z-50 w-72 sm:w-80 rounded-2xl border p-2 shadow-2xl backdrop-blur-2xl select-none ${
                      isDark 
                  ...
                  >
                    <div className="px-2.5 py-1.5 flex items-center justify-between border-b border-zinc-800/60 mb-1">
                      <span className="text-[10px] uppercase tracking-wider font-mono font-semibold text-zinc-400">
                        Attach & Tools
                      </span>
                    </div>
                    ...
                    <div className="space-y-0.5">
                      ...
                      >
                        ...
                        <div className="min-w-0">
                          <p className="text-xs font-semibold leading-none mb-0.5">Attach Files</p>
                          <p className="text-[10px] text-zinc-400 leading-tight">Code, PDFs, text, or spreadsheets</p>
                        </div>
                      </button>
                      ...
                      >
                        ...
                        <div className="min-w-0">
                          <p className="text-xs font-semibold leading-none mb-0.5">Attach Images</p>
                          <p className="text-[10px] text-zinc-400 leading-tight">Upload photos, diagrams, or screenshots</p>
                        </div>
                      </button>
                      ...
                      >
                        ...
                        <div className="min-w-0">
                          <p className="text-xs font-semibold leading-none mb-0.5">Camera</p>
                          <p className="text-[10px] text-zinc-400 leading-tight">Snap a quick photo with webcam</p>
                        </div>
                      </button>
                      ...
                      >
                        ...
                        <div className="min-w-0">
                          <p className="text-xs font-semibold leading-none mb-0.5">Voice Input</p>
                          <p className="text-[10px] text-zinc-400 leading-tight">Dictate prompt with speech-to-text</p>
                        </div>
                      </button>
                    </div>
                    ...
                    <div className="mt-1 pt-1 border-t border-zinc-800/60">
                      ...
                      >
                        ...
                        <div className="flex items-center gap-1">
                          <span className="text-[9px] font-mono px-1.5 py-0.5 rounded bg-indigo-500/10 text-indigo-400">8</span>
                          <ChevronDown className={`w-3.5 h-3.5 transition-transform duration-200 ${showMoreTools ? "rotate-180" : ""}`} />
                        </div>
                      </button>
                      ...
                      <AnimatePresence>
                        {showMoreTools && (
                          <motion.div
                            ...
                            className="overflow-hidden space-y-0.5 pt-1 max-h-56 overflow-y-auto pr-0.5 scroll-smooth"
                          >
                            {/* Record Voice Note */}
                            <button
                              type="button"
                            ...
                            >
                              ...
                              <div className="min-w-0">
                                <p className="text-xs font-medium leading-none mb-0.5">Voice Note</p>
                                <p className="text-[9px] text-zinc-400 leading-tight">Record audio clip</p>
                              </div>
                            </button>
                            ...
                            >
                              ...
                              <div className="min-w-0">
                                <p className="text-xs font-medium leading-none mb-0.5">Location</p>
                                <p className="text-[9px] text-zinc-400 leading-tight">Attach GPS coordinates</p>
                              </div>
                            </button>
                            ...
                            >
                              ...
                              <div className="min-w-0">
                                <p className="text-xs font-medium leading-none mb-0.5">Google Docs</p>
                                <p className="text-[9px] text-zinc-400 leading-tight">Import Google Workspace docs</p>
                              </div>
                            </button>
                            ...
                            >
                              ...
                              <div className="min-w-0">
                                <p className="text-xs font-medium leading-none mb-0.5">Capture Screen</p>
                                <p className="text-[9px] text-zinc-400 leading-tight">Snap screen screenshot</p>
                              </div>
                            </button>
                            ...
                            >
                              <div className="w-7 h-7 rounded-lg bg-fuchsia-500/10 text-fuchsia-400 flex items-center justify-center shrink-0">
                                <Sparkles className="w-3.5 h-3.5" />
                              </div>
                              <div className="min-w-0">
                                <p className="text-xs font-medium leading-none mb-0.5">AI Image Generator</p>
                                <p className="text-[9px] text-zinc-400 leading-tight">Generate illustrations with AI</p>
                              </div>
                            </button>
                            ...
                            >
                              ...
                              <div className="min-w-0 flex-1">
                                <div className="flex items-center justify-between">
                                  <p className="text-xs font-medium leading-none mb-0.5">Web Search</p>
                                  {webSearchActive && <span className="w-1.5 h-1.5 rounded-full bg-emerald-500" />}
                                </div>
                                <p className="text-[9px] text-zinc-400 leading-tight">Live web answers</p>
                              </div>
                            </button>
                            ...
                            >
                              ...
                              <div className="min-w-0">
                                <p className="text-xs font-medium leading-none mb-0.5">Run Code</p>
                                <p className="text-[9px] text-zinc-400 leading-tight">Python / JS sandbox</p>
                              </div>
                            </button>
                            ...
                            >
                              ...
                              <div className="min-w-0">
                                <p className="text-xs font-medium leading-none mb-0.5">Cloud Files</p>
                                <p className="text-[9px] text-zinc-400 leading-tight">Google Drive & OneDrive</p>
                              </div>
                            </button>
                          </motion.div>
                        )}
