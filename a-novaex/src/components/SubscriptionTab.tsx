...
export default function SubscriptionTab({
  ...
  const [currentPlanId, setCurrentPlanId] = useState<string>("none");
  ...
  const [billingHistory, setBillingHistory] = useState<InvoiceItem[]>([
    {
      ...
      currency: "INR",
      status: "Paid",
      paymentMethod: "PhonePe UPI (alex.nova@ybl)",
...
====================================================
  ...
  return (
    ...
    >
      {/* PAGE HEADER */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 md:gap-4 border-b border-zinc-800/80 pb-4 md:pb-5">
        <div>
          <div className="flex items-center gap-2 md:gap-2.5">
            <h2 className="text-lg sm:text-xl lg:text-2xl font-extrabold text-white tracking-tight flex items-center gap-2">
              <Sparkles className="w-4 h-4 sm:w-5 sm:h-5 text-purple-400 shrink-0 animate-pulse" />
              <span>Subscription</span>
            </h2>
            <span className="px-2 py-0.5 text-[9px] sm:text-[10px] font-bold uppercase tracking-wider rounded-full bg-purple-500/10 text-purple-400 border border-purple-500/20">
              Billing & Perks
            </span>
          </div>
          <p className="text-xs lg:text-sm text-zinc-400 mt-0.5 sm:mt-1">
      ...
      <div className="p-4 sm:p-5 md:p-5 lg:p-7 rounded-2xl md:rounded-3xl bg-white dark:bg-zinc-950/90 border border-zinc-200 dark:border-zinc-800/80 shadow-md dark:shadow-2xl relative overflow-hidden space-y-4 md:space-y-5 lg:space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 md:gap-5 border-b border-zinc-200 dark:border-zinc-800/80 pb-4 md:pb-5">
          <div className="space-y-1.5 md:space-y-2">
            <div className="flex flex-wrap items-center gap-2 md:gap-2.5">
              ...
              {/* Plan Badge */}
              <span className="px-2 py-0.5 md:px-2.5 md:py-0.5 text-[9px] md:text-[10px] font-black uppercase tracking-wider rounded-md bg-purple-500/20 text-purple-700 dark:text-purple-300 border border-purple-500/30">
                {currentPlan.badge}
              </span>
            </div>
        ...
        <div className="p-3 md:p-4 rounded-xl md:rounded-2xl bg-purple-500/10 border border-purple-500/20 flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 text-xs">
          <div className="flex items-center gap-2 text-purple-900 dark:text-purple-200">
            <ShieldCheck className="w-4 h-4 text-purple-600 dark:text-purple-400 shrink-0" />
            <span className="text-[11px] md:text-xs">
              <strong>Next Payment:</strong> {getCurrentPrice()} scheduled for <strong>{renewalDate}</strong> using saved PhonePe UPI.
            </span>
          </div>
          <span className="text-[10px] md:text-[11px] text-zinc-500 dark:text-zinc-400 font-mono self-start sm:self-center shrink-0">
            Invoice: INV-2026-NEXT
          </span>
        </div>
      </div>
      ...
      {hasActiveTrial || subStatus === "trial" ? (
        ...
        <div className="p-3.5 sm:p-4 rounded-xl sm:rounded-2xl bg-zinc-50 dark:bg-zinc-900/60 border border-zinc-200 dark:border-zinc-800/80 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 text-xs">
          ...
          <button
            ...
            className="px-3.5 py-2 rounded-xl bg-zinc-800 hover:bg-zinc-700 text-purple-300 border border-purple-500/30 text-xs font-bold transition-all cursor-pointer shrink-0 w-full sm:w-auto min-h-[40px] sm:min-h-0"
          >
            Claim Free Trial
          </button>
        </div>
      ...
      {/* ========================================================= */}
      {/* 4. COMPACT USAGE CARDS                                    */}
      {/* ========================================================= */}
      <div className="p-4 sm:p-5 md:p-5 lg:p-6 rounded-2xl md:rounded-3xl bg-white dark:bg-zinc-950/80 border border-zinc-200 dark:border-zinc-800/80 space-y-3 md:space-y-4 shadow-xs">
        <div className="flex items-center justify-between border-b border-zinc-200 dark:border-zinc-800/80 pb-3">
          <div>
            <h4 className="text-xs lg:text-sm font-extrabold text-zinc-900 dark:text-white uppercase tracking-wider flex items-center gap-2">
              <Zap className="w-4 h-4 text-sky-500 dark:text-sky-400 shrink-0" />
              <span>Current Usage & Limits</span>
            </h4>
            <p className="text-[11px] text-zinc-500 dark:text-zinc-400 mt-0.5">
              Monitored resource consumption for your current billing period.
            </p>
          </div>
          <span className="text-[10px] font-mono text-zinc-500 dark:text-zinc-400 shrink-0">Resets {usageData.messages.resetDate}</span>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-3.5">
          {/* Card 1: Messages */}
          <div className="p-3.5 md:p-4 rounded-xl md:rounded-2xl bg-zinc-50 dark:bg-zinc-900/90 border border-zinc-200 dark:border-zinc-800/80 space-y-2">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <MessageSquare className="w-4 h-4 text-purple-600 dark:text-purple-400" />
                <span className="text-xs font-bold text-zinc-900 dark:text-white">Messages</span>
              </div>
              <span className="text-[11px] font-bold text-zinc-700 dark:text-zinc-300">
                {usageData.messages.current} / {usageData.messages.max}
              </span>
            </div>
            <div className="w-full h-2 bg-zinc-200 dark:bg-zinc-950 rounded-full overflow-hidden border border-zinc-300 dark:border-zinc-800/80">
              <div
                className="h-full bg-purple-500 rounded-full transition-all duration-500"
                style={{ width: `${(usageData.messages.current / usageData.messages.max) * 100}%` }}
              />
            </div>
            <p className="text-[10px] text-zinc-500 dark:text-zinc-400 text-right">Reset date: {usageData.messages.resetDate}</p>
          </div>
          ...
          <div className="p-3.5 md:p-4 rounded-xl md:rounded-2xl bg-zinc-50 dark:bg-zinc-900/90 border border-zinc-200 dark:border-zinc-800/80 space-y-2">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-bold text-zinc-900 dark:text-white">AI Images</span>
              </div>
              <span className="text-[11px] font-bold text-zinc-700 dark:text-zinc-300">
                {usageData.images.current} / {usageData.images.max}
              </span>
            </div>
            <div className="w-full h-2 bg-zinc-200 dark:bg-zinc-950 rounded-full overflow-hidden border border-zinc-300 dark:border-zinc-800/80">
              <div
                className="h-full bg-emerald-500 rounded-full transition-all duration-500"
                style={{ width: `${(usageData.images.current / usageData.images.max) * 100}%` }}
              />
            </div>
            <p className="text-[10px] text-zinc-500 dark:text-zinc-400 text-right">Reset date: {usageData.images.resetDate}</p>
          </div>
          ...
          <div className="p-3.5 md:p-4 rounded-xl md:rounded-2xl bg-zinc-50 dark:bg-zinc-900/90 border border-zinc-200 dark:border-zinc-800/80 space-y-2">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-bold text-zinc-900 dark:text-white">Voice Minutes</span>
              </div>
              <span className="text-[11px] font-bold text-zinc-700 dark:text-zinc-300">
                {usageData.voiceMinutes.current} / {usageData.voiceMinutes.max} m
              </span>
            </div>
            <div className="w-full h-2 bg-zinc-200 dark:bg-zinc-950 rounded-full overflow-hidden border border-zinc-300 dark:border-zinc-800/80">
              <div
                className="h-full bg-sky-500 rounded-full transition-all duration-500"
                style={{ width: `${(usageData.voiceMinutes.current / usageData.voiceMinutes.max) * 100}%` }}
              />
            </div>
            <p className="text-[10px] text-zinc-500 dark:text-zinc-400 text-right">Reset date: {usageData.voiceMinutes.resetDate}</p>
          </div>
          ...
          <div className="p-3.5 md:p-4 rounded-xl md:rounded-2xl bg-zinc-50 dark:bg-zinc-900/90 border border-zinc-200 dark:border-zinc-800/80 space-y-2">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-bold text-zinc-900 dark:text-white">File Uploads</span>
              </div>
              <span className="text-[11px] font-bold text-zinc-700 dark:text-zinc-300">
                {usageData.fileUploads.current} / {usageData.fileUploads.max}
              </span>
            </div>
            <div className="w-full h-2 bg-zinc-200 dark:bg-zinc-950 rounded-full overflow-hidden border border-zinc-300 dark:border-zinc-800/80">
              <div
                className="h-full bg-amber-500 rounded-full transition-all duration-500"
                style={{ width: `${(usageData.fileUploads.current / usageData.fileUploads.max) * 100}%` }}
              />
            </div>
            <p className="text-[10px] text-zinc-500 dark:text-zinc-400 text-right">Reset date: {usageData.fileUploads.resetDate}</p>
          </div>
          ...
          <div className="p-3.5 md:p-4 rounded-xl md:rounded-2xl bg-zinc-50 dark:bg-zinc-900/90 border border-zinc-200 dark:border-zinc-800/80 space-y-2">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-bold text-zinc-900 dark:text-white">Storage</span>
              </div>
              <span className="text-[11px] font-bold text-zinc-700 dark:text-zinc-300">
                {usageData.storageGb.current} GB / {usageData.storageGb.max} GB
              </span>
            </div>
            <div className="w-full h-2 bg-zinc-200 dark:bg-zinc-950 rounded-full overflow-hidden border border-zinc-300 dark:border-zinc-800/80">
              <div
                className="h-full bg-rose-500 rounded-full transition-all duration-500"
                style={{ width: `${(usageData.storageGb.current / usageData.storageGb.max) * 100}%` }}
              />
            </div>
            <p className="text-[10px] text-zinc-500 dark:text-zinc-400 text-right">Reset date: {usageData.storageGb.resetDate}</p>
          </div>
          ...
          <div className="p-3.5 md:p-4 rounded-xl md:rounded-2xl bg-zinc-50 dark:bg-zinc-900/90 border border-zinc-200 dark:border-zinc-800/80 space-y-2">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-bold text-zinc-900 dark:text-white">API Tokens</span>
              </div>
              <span className="text-[11px] font-bold text-zinc-700 dark:text-zinc-300">
                {usageData.apiTokens.current.toLocaleString()} / {usageData.apiTokens.max.toLocaleString()}
              </span>
            </div>
            <div className="w-full h-2 bg-zinc-200 dark:bg-zinc-950 rounded-full overflow-hidden border border-zinc-300 dark:border-zinc-800/80">
              <div
                className="h-full bg-purple-500 rounded-full transition-all duration-500"
                style={{ width: `${(usageData.apiTokens.current / usageData.apiTokens.max) * 100}%` }}
              />
            </div>
            <p className="text-[10px] text-zinc-500 dark:text-zinc-400 text-right">Reset date: {usageData.apiTokens.resetDate}</p>
          </div>
        </div>
      </div>
          ...
          {[
            ...
            >
              <div className="flex items-center justify-between text-xs font-bold text-zinc-900 dark:text-white gap-2">
                <span>{item.q}</span>
                {expandedFaq === idx ? <ChevronUp className="w-4 h-4 text-zinc-400 shrink-0" /> : <ChevronDown className="w-4 h-4 text-zinc-400 shrink-0" />}
              </div>
              {expandedFaq === idx && (
