      ...
      <AnimatePresence>
        {unsupportedMsg && (
          <motion.div
            ...
            className="fixed top-5 left-1/2 -translate-x-1/2 z-[10000] px-4 py-3 rounded-2xl bg-zinc-900 border border-zinc-800 text-zinc-200 text-xs shadow-2xl flex items-center gap-2.5 max-w-sm text-center"
          >
