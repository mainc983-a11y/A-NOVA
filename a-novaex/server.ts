...
app.post("/api/chats/:id/message", authenticate, async (req, res) => {
  ...
  try {
    ...
    const antiRoboticInstruction = "\n\n[CRITICAL DIRECTIVE ON STYLE/TONE - DO NOT VIOLATE]:\n" +
      ...
      "3. Keep answers directly targeted to the user's question, matching the tone and complexity requirements.\n" +
      ...
      "5. NEVER mention memory limitations or say 'I cannot remember previous conversations' unless asked.\n" +
      "6. RESPONSE LENGTH RULES:\n" +
      "   - Short/Simple Question -> Short/Simple Answer.\n" +
      "   - Substantive, Deep, or Complex Question -> Give an exhaustive, detailed response with deep step-by-step reasoning, bullet points, code blocks, or mathematical breakdowns. Do not prematurely truncate or summarize responses that count on detailed elaboration.\n" +
