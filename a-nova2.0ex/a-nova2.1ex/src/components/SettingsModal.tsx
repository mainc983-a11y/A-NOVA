  ...
  return (
    <div id="settings_modal_wrapper" className="fixed inset-0 z-50 flex items-center justify-center p-0 md:p-4 lg:p-6 overflow-hidden select-none">
      ...
      <motion.div
        ...
        className="w-full h-full md:h-[88vh] max-w-5xl bg-zinc-900 border-0 md:border border-zinc-800/90 rounded-none md:rounded-2xl shadow-2xl relative z-10 flex flex-col md:flex-row overflow-hidden font-sans text-zinc-100"
      >
                ...
                >
                  ...
                  <div className="p-5 rounded-2xl bg-zinc-950/80 border border-zinc-800/80 space-y-3">
                    ...
                    >
                      ...
                      <option value="gemini-2.5-pro">Gemini 2.5 Pro (Deep reasoning & code)</option>
                      <option value="gemini-2.5-flash-lite">Gemini 2.5 Flash Lite (Compact model)</option>
                    </select>
                  </div>
