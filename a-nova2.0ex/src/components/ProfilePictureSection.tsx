        ...
        {cropImageSrc && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-md">
            ...
            >
              ...
              <div 
                className="relative w-64 h-64 mx-auto bg-black rounded-2xl overflow-hidden cursor-grab active:cursor-grabbing border border-zinc-800 flex items-center justify-center select-none"
