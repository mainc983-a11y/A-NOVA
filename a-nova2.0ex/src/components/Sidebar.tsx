...
const Sidebar = React.memo(function Sidebar({
  ...
  return (
    <>
      ...
      <aside
        id="side_navigation"
        className={`fixed md:sticky top-0 left-0 bottom-0 z-50 flex flex-col h-screen h-[100dvh] transition-all duration-300 ease-out md:translate-x-0 ${
          isOpen ? "translate-x-0" : "-translate-x-full"
        } ${isCollapsed ? "md:w-16 w-72 max-w-[85vw]" : "md:w-68 w-72 max-w-[85vw]"} ${
          isDark 
