...
const ChatInterface = React.memo(function ChatInterface({
  ...
  return (
    ...
    >
      ...
      {/* Unified Input area */}
      <footer className={`p-2 sm:p-4 border-t shrink-0 pb-safe ${
        ...
        <div className="max-w-2xl mx-auto space-y-2 sm:space-y-3">
          ...
          >
            ...
            {webSearchActive && (
              <div className="flex items-center gap-1.5 px-4 pt-2.5 select-none text-emerald-500 text-[10px] font-bold font-mono">
            ...
            <div className="flex items-center gap-2 px-3 py-2">
              ...
              <textarea
                ...
                className="w-full bg-transparent px-1 py-1 text-base sm:text-sm focus:outline-none placeholder-zinc-400 dark:placeholder-zinc-500 font-sans resize-none block flex-1 max-h-36 min-h-[2.25rem] overflow-y-auto"
              />
              ...
              <div className="flex items-center gap-1.5 shrink-0">
                ...
                {(!inputText.trim() && attachedFiles.length === 0) ? (
                  ...
                  <button
                    ...
                    className="flex h-9 w-9 items-center justify-center rounded-full bg-purple-600 hover:bg-purple-550 text-white shadow-md transition-all cursor-pointer disabled:opacity-50"
                    title="Send message"
                  >
                    {loading ? <Loader2 className="w-4.5 h-4.5 animate-spin" /> : <ArrowUp className="w-4.5 h-4.5 stroke-[2.5]" />}
                  </button>
                )}
