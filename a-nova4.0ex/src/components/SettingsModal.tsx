              ...
              {activeTab === "profile" && (
                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row items-center gap-4 p-4 rounded-2xl bg-zinc-950 border border-zinc-850">
                    ...
                    <div className="flex-1 min-w-0 w-full">
                      ...
                      <div className="flex items-center gap-1.5 text-[10px] text-zinc-500 font-mono mt-2">
                        ...
                        <span>Registered: {user?.createdAt ? new Date(user.createdAt).toLocaleDateString("en-US", { year: 'numeric', month: 'long', day: 'numeric' }) : "Active User"}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {/* Email address */}
                    <div>
                      <label className="block text-[10px] font-bold font-mono text-zinc-400 mb-2 uppercase tracking-wider">Email Address</label>
                      <input
                        ...
                        disabled
                        value={emailAddress}
                        placeholder="Active email address (Read-Only)"
                        className="w-full px-4 py-2.5 bg-zinc-950/60 border border-zinc-900 text-xs text-zinc-400 rounded-xl focus:outline-none transition-all cursor-not-allowed"
                      />
                    </div>

                    {/* Phone Number */}
                    <div>
                      <label className="block text-[10px] font-bold font-mono text-zinc-400 mb-2 uppercase tracking-wider">Phone Number</label>
                      <input
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="Plus">A-NOVA Plus ($20/mo)</option>
