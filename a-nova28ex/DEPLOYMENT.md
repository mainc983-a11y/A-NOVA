...
- The platform automatically spins up the Node server on Port `3000`. Open `https://ais-dev-cani2npmpszcm6egelanep-266602237293.asia-east1.run.app` to interact with MyAI!
