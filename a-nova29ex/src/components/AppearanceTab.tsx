...
function AppearanceTabComponent({
  settings,
  onSaveSettings,
  showSuccess,
  showError,
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-4 border-b border-zinc-200 dark:border-zinc-800/80">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[12.5px] sm:text-sm font-normal text-zinc-500 dark:text-zinc-400 mt-0.5 leading-[1.35] break-words max-w-full">
...
export default React.memo(AppearanceTabComponent);
